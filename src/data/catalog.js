...
const raw = [
  ...
  {
    id: 401, category: 'Кирпич рядовой',
    title: 'Кирпич рядовой «Графит» полнотелый',
    image: '/public/assets/products/step-1.jpg',
    short: 'Рядовой кирпич для несущих стен и перегородок. Высокая морозостойкость.',
    description: `Рядовой кирпич для кладки несущих и ненесущих конструкций. ${lorem.delivery} ${lorem.docs}`,
    specs: [
      ['Назначение', 'несущие/перегородки'], ['Морозостойкость', 'высокая'], ['Поверхность', 'гладкая'],
      ['Цвет', 'графит'], ['Марка', 'М125–М150']
    ],
    color: 'графит',
    format: '1NF',
    tags: ['рядовой', 'кирпич'],
